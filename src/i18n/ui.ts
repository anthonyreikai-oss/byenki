...
export const UI = {
  ...
  "nav.series_toggle": { es: "CATEGORÍAS", en: "CATEGORIES" },
  ...
  "nav.series_term": { es: "series@archivo:~/", en: "series@archive:~/"},
  ...
  "nav.mobile_series": { es: "CATEGORÍAS", en: "CATEGORIES" },
  ...
  "sidebar.series": { es: "CATEGORÍAS", en: "CATEGORIES" },
